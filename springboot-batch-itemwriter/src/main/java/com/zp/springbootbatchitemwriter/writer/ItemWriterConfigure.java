package com.zp.springbootbatchitemwriter.writer;
...
public class ItemWriterConfigure {
    ...
    public FlatFileItemWriter<TestData> fileItemWriter() throws Exception {
        ...
        FileSystemResource file = new FileSystemResource("F:\\大学\\Java\\springboot-review\\springboot-batch-itemwriter\\src\\main\\resources\\file1");
    ...
    public StaxEventItemWriter<TestData> xmlFileItemWriter() throws Exception {
        ...
        FileSystemResource file = new FileSystemResource("F:\\大学\\Java\\springboot-review\\springboot-batch-itemwriter\\src\\main\\resources\\file1.xml");
        Path path = Paths.get(file.getPath());
        if (!Files.exists(path)) {
            Files.createFile(path);
        }
