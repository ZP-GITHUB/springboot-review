package com.zp.springbootbatchlauncher.controller;
...
public class JobController {
    ...
    /**
     * JobOperator的start(String jobName, String parameters)方法传入的是任务的名称（任务在Spring IOC容器中的名称）,
     * 并且参数使用key-value的方式传递
     */
    @Autowired
